...
The first passenger receives the left seat and the second passenger receives the right seat. The seat offset is currently `0.4` blocks from the horse center, matching the basic horizontal spacing used by boats.
